        ...
        componentWillUnmount: function() {
            ...
            render: function () {
                ...
                for (var i = 0; i < arr.length; i++) {
                    var tab = arr[i];
                    items.push(
                        <li className={this.state.activeIndex==i?"active":""} onClick={this.activeTab.bind(this,i)}
                            onMouseOver={this.handleMouseOver.bind(this,i)}
                            onMouseOut={this.handleMouseOut.bind(this,i)}>
                            <a href="javascript:void(0);" style={tabsStyle.tabStyle}>
                                <span
                                    className={this.state.activeIndex==i||this.state.hoverIndex==i?"glyphicon glyphicon-remove":""}
                                    style={tabsStyle.closeBtnStyle} onClickCapture={this.removeTab.bind(this,i)}></span>
                                <div style={tabsStyle.separatedStyle}></div>
                                <div style={tabsStyle.titleStyle}>{tab.MenuTitle}</div>
                            </a>
                        </li>
                    );
                }
