...
define(['react','reactdom','jquery'], function (React,ReactDOM,$) {
    ...
    var DialogComponent=React.createClass({displayName: "DialogComponent",
       getInitialState: function () {
        ...
        render: function () {
            ...
            var  headingStyle={width:"100%",height:"40px"};
            var bodyStyle={height:(height-40)+"px",overflow:"auto"};
            ...
            return(
                React.createElement("div", null, 
                    ...
                    React.createElement("div", {className: "panel panel-default", style: boxStyle}, 
                        React.createElement("div", {className: "panel-heading", style: headingStyle}, 
                            React.createElement("table", {style: tableStyle}, 
                                React.createElement("tr", null, 
                                    React.createElement("td", {style: titleStyle}, title), 
                        ...
                        React.createElement("div", {className: "panel-body", style: bodyStyle, ref: "panelBody"}
                        )
                    )
                )
            );
