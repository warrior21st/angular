    ...
    var Uploader=React.createClass({displayName: "Uploader",
       getInitialState: function () {
        ...
        render: function () {
            ...
            return (React.createElement("div", {style: boxStyle}, React.createElement("button", {type: "button", className: "btn btn-default", onClick: this._chooseFile.bind(this)}, "选择文件"), "  ", 
                React.createElement("button", {type: "button", className: "btn btn-default", style: this.props.showUploadBtn===false?hideStyle:showStyle, onClick: this.upload.bind(this)}, "开始上传"), 
                this.props.multiple?(React.createElement("input", {type: "file", ref: "fileinput", name: "fileinput_0.0.1", multiple: "multiple", style: hideStyle, onChange: this._onchange.bind(this)})):
            (React.createElement("input", {type: "file", ref: "fileinput", name: "fileinput_0.0.1", style: hideStyle, onChange: this._onchange.bind(this)})), 
                React.createElement(ProgressBar, {percent: this.state.percent})));
        }
    });
