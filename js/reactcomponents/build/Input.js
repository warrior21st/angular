...
define(['react','jquery','./InputDataTypes'],function(React,$,Vtypes){
    ...
    var InputBox=React.createClass({displayName: "InputBox",
        ...
        render: function () {
            ...
            var toolTip= (React.createElement("span", {className: "label label-danger", style: tooltipStyle}, errMsg));

            if(typeobj.domType!="textarea") {
                if(!this.props.addon) {
                    return (React.createElement("div", null, React.createElement("input", {id: this.props.modelHandler.model.replace(new RegExp('\\.','g'),"_"), type: type, 
                    ...
                    return (React.createElement("div", null, React.createElement("div", {className: "input-group"}, 
                        this.props.addon.location=="left"?this.props.addon.content:null, 
                        React.createElement("input", {id: this.props.modelHandler.model.replace(new RegExp('\\.','g'),"_"), type: type, 
                                        className: this.props.className||"", 
                                        style: this.state.changed?(this.state.valid?styleValid:styleInvalid):(this.props.style||{}), 
                                        placeholder: this.props.placeholder||"", 
                                        value: this.state.value, 
                ...
                return(React.createElement("div", null, React.createElement("textarea", {id: this.props.modelHandler.model.replace(new RegExp('\\.','g'),"_"), type: type, 
                                   className: this.props.className||"", 
                                   style: this.state.changed?(this.state.valid?styleValid:styleInvalid):(this.props.style||{}), 
                                   placeholder: this.props.placeholder||"", 
                                   ref: this.props.modelHandler.model.replace(new RegExp('\\.','g'),"_"), 
