    ...
    var ProgressBar=React.createClass({displayName: "ProgressBar",
       getInitialState: function () {
        ...
        render: function () {
            ...
            return(React.createElement("div", {style: hide?hideStyle:showStyle}, 
            React.createElement("div", {style: maskStyle}), 
                React.createElement("div", {className: "progress", style: boxStyle}, 
                    React.createElement("div", {className: "progress-bar progress-bar-info", role: "progressbar", "aria-valuenow": this.state.percent, "aria-valuemin": "0", "aria-valuemax": "100", style: proStyle}
                    ), 
